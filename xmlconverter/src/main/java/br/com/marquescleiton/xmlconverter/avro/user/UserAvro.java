 ...
 */
package br.com.marquescleiton.xmlconverter.avro.user;
...
public class UserAvro extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 5938159472492822028L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"UserAvro\",\"namespace\":\"br.com.marquescleiton.xmlconverter.avro.user\",\"fields\":[{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"favorite_number\",\"type\":[\"int\",\"null\"]},{\"name\":\"favorite_color\",\"type\":[\"string\",\"null\"]}]}");
   ...
   */
  public UserAvro(java.lang.CharSequence name, java.lang.Integer favorite_number, java.lang.CharSequence favorite_color) {
    this.name = name;
   ...
   */
  public static br.com.marquescleiton.xmlconverter.avro.user.UserAvro.Builder newBuilder() {
    return new br.com.marquescleiton.xmlconverter.avro.user.UserAvro.Builder();
  }
   ...
   * @return A new UserAvro RecordBuilder
   */
  public static br.com.marquescleiton.xmlconverter.avro.user.UserAvro.Builder newBuilder(br.com.marquescleiton.xmlconverter.avro.user.UserAvro.Builder other) {
    if (other == null) {
      return new br.com.marquescleiton.xmlconverter.avro.user.UserAvro.Builder();
    } else {
      return new br.com.marquescleiton.xmlconverter.avro.user.UserAvro.Builder(other);
    }
  }
   ...
   * @return A new UserAvro RecordBuilder
   */
  public static br.com.marquescleiton.xmlconverter.avro.user.UserAvro.Builder newBuilder(br.com.marquescleiton.xmlconverter.avro.user.UserAvro other) {
    if (other == null) {
      return new br.com.marquescleiton.xmlconverter.avro.user.UserAvro.Builder();
    } else {
      return new br.com.marquescleiton.xmlconverter.avro.user.UserAvro.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<UserAvro>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(br.com.marquescleiton.xmlconverter.avro.user.UserAvro.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(br.com.marquescleiton.xmlconverter.avro.user.UserAvro other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.marquescleiton.xmlconverter.avro.user.UserAvro.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.marquescleiton.xmlconverter.avro.user.UserAvro.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.marquescleiton.xmlconverter.avro.user.UserAvro.Builder setFavoriteNumber(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.marquescleiton.xmlconverter.avro.user.UserAvro.Builder clearFavoriteNumber() {
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.marquescleiton.xmlconverter.avro.user.UserAvro.Builder setFavoriteColor(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.marquescleiton.xmlconverter.avro.user.UserAvro.Builder clearFavoriteColor() {
      favorite_color = null;
